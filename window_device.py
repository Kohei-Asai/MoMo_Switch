...
class App(tk.Frame):
    def __init__(self, master = None):
        ...
        self.button_brush.grid(column=1, row=0)
        ...
        self.label_brush_completed.grid(column=2, row=0)
        ...
        self.button_drink.grid(column=1, row=1)
        ...
        self.label_drink_completed.grid(column=2, row=1)
        ...
        self.button_senobi.grid(column=1, row=2)
        ...
        self.label_senobi_completed.grid(column=2, row=2)
        ...
        self.button_walk.grid(column=1, row=3)
        ...
        self.label_walk_completed.grid(column=2, row=3)
        ...
        self.button_face.grid(column=1, row=4)
        ...
        self.label_face_completed.grid(column=2, row=4)
        ...
        self.button_all.grid(column=2, row=5)
